...
from planning_utils_2 import a_star, heuristic, create_grid, valid_actions, Action
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        if grid_goal[0] > 921:
            print("ERROR: Goal Coordinate 0 - ", grid_goal[0], " is Going out of Bounds!")
            self.landing_transition()
            return
        if grid_goal[1] > 921:
            print("ERROR: Goal Coordinate 1 - ", grid_goal[1], " is Going out of Bounds!")
            self.landing_transition()
            return
